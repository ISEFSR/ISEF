...
{
    public partial class NewOkresForm : DialogBase
    {
        public NewOkresForm(ISEFDataManager manager)
        {
            InitializeComponent();

            ShowImageIcon = false;

            comboBoxKraj.DataSource = manager.Kraje;

            comboBoxKraj.SelectedIndex = 0;
        }
        ...
        public KrajRiadok Kraj { get => comboBoxKraj.SelectedItem as KrajRiadok; }
        ...
        private void cueTextBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                var text = "Kód pre číselník okresov musí byť celé číslo";
