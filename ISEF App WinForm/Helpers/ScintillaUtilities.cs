...
{
    class ScintillaUtilities
    {
        public static void SetScintillaControl(ScintillaNET.Scintilla scintilla)
        {
            // Reset the styles
            ...
            //scintilla.Styles[Style.Default].BackColor = Color.FromArgb(32, 32, 32);
            //scintilla.Styles[Style.Default].ForeColor = Color.FromArgb(250, 250, 250);
